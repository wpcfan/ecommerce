...
class PaypalWebhookView(View):
    ...
    def post(self, request, *_args, **_kwargs):
        ...
        try:
            ...
            transmission_sig = request.META['HTTP_PAYPAL_TRANSMISSION__SIG']
        ...
        if not processor.verify_webhook_event(
            transmission_id, transmission_time, body, cert_url, transmission_sig, auth_algo):
            return HttpResponseForbidden()

        body = json.loads(body)
        url = 'https://www.paypal.com/us/cgi-bin/webscr?cmd=_unauth-view-details&cid={}'.format(body['resource']['dispute_id'])
        logger.info('Dispute opened at %s', url)
