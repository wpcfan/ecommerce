...
from oscar.apps.payment.exceptions import PaymentError, TransactionDeclined, UserCancelled, GatewayError
...
class ApplePayMerchantDomainAssociationView(CyberSourceProcessorMixin, View):
    def get(self, request, *args, **kwargs):  # pylint: disable=unused-argument
        ...
        return HttpResponse(content, content_type='text/plain', status=status)
